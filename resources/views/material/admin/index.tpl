...
<main class="content">
	<div class="content-header ui-content-header">
		<div class="container">
			<h1 class="content-heading">汇总</h1> </div>
	</div>
	<div class="container">
										...
										var chart = new CanvasJS.Chart("node_chart", {
													...
													data: [{
															...
															dataPoints: [{
																	...
																	y: {
																		(1 - ($sts - > getAliveSSNode() / $sts - > getTotalSSNode())) * 100
																	},
																	...
																	y: {
																		(($sts - > getAliveSSNode() / $sts - > getTotalSSNode())) * 100
																	},
										...
										var chart = new CanvasJS.Chart("traffic_chart", {
													...
													data: [{
															...
															dataPoints: [{
																	...
																	y: {
																		(($sts - > getRawUnusedTrafficUsage() / $sts - > getRawTotalTraffic())) * 100
																	},
																	...
																	y: {
																		(($sts - > getRawLastTrafficUsage() / $sts - > getRawTotalTraffic())) * 100
																	},
																	...
																	y: {
																		(($sts - > getRawTodayTrafficUsage() / $sts - > getRawTotalTraffic())) * 100
																	},
