...
<body class="page-red">
	...
	<nav aria-hidden="true" class="menu menu-left nav-drawer nav-drawer-md" id="ui_menu" tabindex="-1">
		<div class="menu-scroll">
			<div class="menu-content"> <a class="menu-logo" href="/"><i class="icon icon-lg">person_pin</i>&nbsp;管理面板</a>
				<ul class="nav">
					<li> <a class="waves-attach" data-toggle="collapse" href="#ui_menu_me">我的</a>
						...
						</ul> <a class="waves-attach" data-toggle="collapse" href="#ui_menu_node">节点</a>
						...
						</ul> <a class="waves-attach" data-toggle="collapse" href="#ui_menu_user">用户</a>
						...
						</ul> <a class="waves-attach" data-toggle="collapse" href="#ui_menu_detect">审计</a>
						...
						</ul> <a class="waves-attach" data-toggle="collapse" href="#ui_menu_trade">交易</a>
