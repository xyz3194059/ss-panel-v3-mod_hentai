...
<script type="text/javascript">
	$().ready(function() {
				chart {
					$id
				} = new CanvasJS.Chart("load{$id}_chart", {
							title: {
								text: "节点负载情况 {$prefix}"
							},
							data: [{
										...
										dataPoints: [{
										...
										} {
											{
												/literal}
												x: new Date({
													$single_load - > log_time * 1000
												}), y: {
													$single_load - > getNodeLoad()
												} {
													literal
												}
											} {
										...
										up_chart {
											$id
										} = new CanvasJS.Chart("up{$id}_chart", {
											title: {
										...
										alive_chart {
											$id
										} = new CanvasJS.Chart("alive{$id}_chart", {
												title: {
												...
												data: [{
															...
															speedtest_chart {
																$id
															} = new CanvasJS.Chart("speedtest{$id}_chart", {
																	title: {
																	...
																	data: [{
																				...
																				dataPoints: [{
																						...
																						} {
																							{
																								/literal}
																								x: new Date({
																									$single_speedtest - > datetime * 1000
																								}), y: {
																									$single_speedtest - > getTelecomPing()
																								}, label: "电信延时" {
																									literal
																								}
																							} {
																									...
																									dataPoints: [{
																											...
																											} {
																												{
																													...
																													x: new Date({
																														...
																														$single_speedtest - > getUnicomPing()
																													}, label: "联通延时" {
																														literal
																													}
																												} {
																													...
																													},
																													{
																														...
																														speedtest_ping_chart {
																															$id
																														} = new CanvasJS.Chart("speedtest{$id}_ping_chart", {
																																title: {
																																			...
																																			dataPoints: [{
																																					...
																																					} {
																																						{
																																							...
																																							x: new Date({
																																								...
																																								$single_speedtest - > getTelecomUpload()
																																							}, label: "电信下载" {
																																								literal
																																							}
																																						} {
																																								...
																																								dataPoints: [{
																																										...
																																										} {
																																											{
																																												...
																																												x: new Date({
																																													...
																																													$single_speedtest - > getTelecomDownload()
																																												}, label: "电信上传" {
																																													literal
																																												}
																																											} {
																																													...
																																													dataPoints: [{
																																															...
																																															} {
																																																{
																																																	...
																																																	x: new Date({
																																																		...
																																																		$single_speedtest - > getUnicomUpload()
																																																	}, label: "联通下载" {
																																																		literal
																																																	}
																																																} {
																																																		...
																																																		dataPoints: [{
																																																				...
																																																				} {
																																																					{
																																																						...
																																																						x: new Date({
																																																							...
																																																							$single_speedtest - > getUnicomDownload()
																																																						}, label: "联通上传" {
																																																							literal
																																																						}
																																																					} {
																																																							...
																																																							dataPoints: [{
																																																									...
																																																									} {
																																																										{
																																																											...
																																																											x: new Date({
																																																												...
																																																												$single_speedtest - > getCmccDownload()
																																																											}, label: "移动上传" {
																																																												literal
																																																											}
																																																										} {
																																																												...
																																																												dataPoints: [{
																																																												...
																																																												} {
																																																													{
																																																														...
																																																														x: new Date({
																																																															...
																																																															$single_speedtest - > getCmccUpload()
																																																														}, label: "移动下载" {
																																																															literal
																																																														}
																																																													} {
