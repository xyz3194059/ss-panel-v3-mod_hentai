...
<main class="content">
					...
					<div class="card margin-bottom-no">
						<div class="card-main">
							<div class="card-inner">
								...
								</div> {if $user->invite_num }
								<div class="card-action">
									<div class="card-action-btn pull-left"> <button id="invite" class="btn btn-flat waves-attach">生成我的邀请码</button> </div>
								</div> {/if} </div>
						</div>
					</div>
				</div>
					...
					<div class="card margin-bottom-no">
						<div class="card-main">
							<div class="card-inner">
								...
								<h3>{$user->user_name}，您不是VIP暂时无法生成邀请码，<a href="/user/shop">成为VIP请点击这里</a></h3> </div>
						</div>
					</div>
				</div>
			</div>
	...
	</div> {/if} {include file='dialog.tpl'} </div>
	</section>
	</div>
