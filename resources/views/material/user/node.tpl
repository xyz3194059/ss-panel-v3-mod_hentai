                                            ...
                                            <div data-toggle="tile" data-target="#heading{$node_order->$prefix}">
                                                ...
                                                <div class="tile-inner">
                                                    <div class="text-overflow">
                                                        <span style="color: #383838; "><img
                                                                    src="/images/prefix/{$prefix}.jpg"
                                                                    height="22" width="40"> {$prefix}
                                                        </span> | <span style="color: #ff9000; "><i
                                                                    class="icon icon-lg">flight_takeoff</i></span>
                                                        <strong><b><span
                                                                        style="color: #474747; ">{$node_alive[$prefix]}</span></b></strong>
                                                        | <span style="color: #ff9000; "><i
                                                                    class="icon icon-lg">import_export</i></span> <span
                                                                style="color: #828282; ">{$node_method[$prefix]}</span>
                                                        | <span
                                                                style="color: #ff9000; "><i
                                                                    class="icon icon-lg">equalizer</i></span> {if isset($node_bandwidth[$prefix])==true}
                                                            <span style="color: #aaaaaa; ">{$node_bandwidth[$prefix]}</span>{else}N/A{/if}
                                                        | <span style="color: #ff9000; "><i
                                                                    class="icon icon-lg">network_check</i></span> <span
                                                                style="color: #a5a5a5; ">{$node->traffic_rate} 倍率</span>
                                                        | <span
                                                                style="color: #ff9000; "><i class="icon icon-lg">notifications_none</i></span>
                                                        <span style="color: #c4c4c4; ">{$node->status}</span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="tile-sub">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-main">
                                                            <div class="card-inner">
                                                                <p class="card-heading"><b><i class="icon icon-lg">visibility_off</i>您无查看权限,如需购买VIP请<a
                                                                                href="/user/shop">点击这里</a>。</b></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {else}
                                                    ...
                                                    <div class="card-main">
                                                        <div class="card-inner">
                                                            <p class="card-heading">
                                                                <a href="javascript:void(0);"
                                                                   onClick="urlChange('{$node->id}',{$single_muport['server']->server},{if $relay_rule != null}{$relay_rule->id}{else}0{/if})">{$prefix} {if $relay_rule != null} - {$relay_rule->dist_node()->name}{/if}
                                                                    - 单 - {$single_muport['server']->server} 端口</a>
                                                            ...
                                                            <p>
                                                                地址：<span
                                                                        class="label label-brand-accent">{$node->server}</span>
                                                            </p>

                                                            <p>
                                                                端口：
                                                                <span class="label label-brand-red">{$single_muport['user']['port']}</span>
                                                            </p>
                                            ...
                                            {foreach $nodes as $node}
                                                ...
                                                <div data-toggle="tile" data-target="#heading{$node_order->$prefix}">
                                                    ...
                                                    <div class="tile-inner">
                                                        <div class="text-overflow">
                                                            <span style="color: #383838; "><img
                                                                        src="/images/prefix/{$prefix}.jpg" height="22"
                                                                        width="40"> {$prefix}</span>
                                                            |
                                                            {if $user->class!=0}
                                                            <span style="color: #ff9000; "><i class="icon icon-lg">flight_takeoff</i></span>
                                                            <strong>
                                                                {else}
                                                                {/if}
                                                                <b><span style="color: #474747; ">{$node_alive[$prefix]}</span></b></strong>
                                                            | <span style="color: #ff9000; "><i class="icon icon-lg">import_export</i></span>
                                                            <span style="color: #828282; ">{$node_method[$prefix]}</span>
                                                            | <span
                                                                    style="color: #ff9000; "><i
                                                                        class="icon icon-lg">equalizer</i></span>
                                                            {if isset($node_bandwidth[$prefix])==true}
                                                                <span style="color: #aaaaaa; ">{$node_bandwidth[$prefix]}</span>{else}N/A
                                                            {/if}
                                                            | <span style="color: #ff9000; "><i class="icon icon-lg">network_check</i></span>
                                                            <span style="color: #a5a5a5; ">{$node->traffic_rate}
                                                                倍率</span> |
                                                            <span style="color: #ff9000; "><i class="icon icon-lg">notifications_none</i></span>
                                                            <span style="color: #c4c4c4; ">{$node->status}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="card-main">
                                                            <div class="card-inner">
                                                                <p class="card-heading" align="center"><b> <i
                                                                                class="icon icon-lg">visibility_off</i> {$user->user_name}
                                                                        ，您无查看VIP节点权限，如需购买VIP请<a
                                                                                href="/user/shop">点击这里</a>。</b></p>
                                                            </div>
                                                        </div>
                                                    </div>
