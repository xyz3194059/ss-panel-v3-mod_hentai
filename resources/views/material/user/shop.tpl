        ...
        <div class="table-responsive">
          ...
          <table class="table ">
            ...
            <tr>
              ...
              <td>{$shop->price} 元</td>
              <td>{$shop->content()}</td>
              <!-- {if $shop->auto_renew==0} <td>不能自动续费</td> {else} <td>可选 在 {$shop->auto_renew} 天后自动续费</td> {/if} {if $shop->auto_reset_bandwidth==0} <td>不自动重置</td> {else} <td>自动重置</td> {/if} -->
              <td>
          ...
          <div class="modal-dialog modal-xs">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <p class="text-right">
                  <button class="btn btn-flat btn-brand waves-attach" data-dismiss="modal" id="coupon_input" type="button">确定</button>
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-inner">
                ...
                <div class="checkbox switch" id="autor">
                  <label for="autorenew">
                    <input checked="checked" class="access-hide" id="autorenew" type="checkbox">
                    <span class="switch-toggle"></span>自动续费
                  </label>
                </div>
              </div>
              <div class="modal-footer">
                <p class="text-right">
                  <button class="btn btn-flat btn-brand waves-attach" data-dismiss="modal" id="order_input" type="button">确定</button>
                </p>
              </div>
            </div>
          </div>
