											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
													...
													<div class="tab-pane fade active in" id="all_ssr_windows">
														...
														<p><span class="icon icon-lg text-white">looks_one</span><a href="/ssr-download/ssr-win.7z"> 點擊我下載</a></p>
                                                          ...
                                                          <p><span class="icon icon-lg text-white">looks_3</span> 運行程序</p>
															...
															<p> <span class="icon icon-lg text-white">looks_4</span> 任務欄右下角右鍵紙飛機圖標--服務器訂閱--SSR服務器訂閱設置，將訂閱鏈接設置爲下面的地址，確定之後再更新 SSR 服務器訂閱。</p>
                                                  ...
                                                  <div class="tab-pane fade" id="all_ssr_linux">
													...
													<div class="tab-pane fade" id="all_ssr_ios">
                                                        <p><span class="icon icon-lg text-white">looks_one</span> 切換<code>App Store</code>賬號-ID:<code>XXXXXXX@icloud.com</code> 密碼<code>XXXXXXXX</code>注意特殊符號與大小寫,如果顯示需要解鎖賬號，請提交工單或郵件。（千萬不要試圖登陸iCloud，會上傳您的照片與通訊錄到這個賬戶上）</p>
														...
														<p><span class="icon icon-lg text-white">looks_3</span> 打開Shadowrocket軟件後，點擊右上角<span class="icon icon-lg text-white">add</span>，添加類型爲<code>Subscribe</code>，URL填寫以下地址即可自動更新節點</p>
                                                      <p><span class="icon icon-lg text-white">looks_4</span> 選擇任意節點點擊連接，然後點擊allow後解鎖指紋</p>
                                                      <p><span class="icon icon-lg text-white">looks_5</span> 注意：第一次連接可能不能用，導入後程序退出並重新打開程序後連接即可！</p>
														<p><span class="icon icon-lg text-white">flash_auto</span> 訂閱地址：<input type="text" class="input form-control form-control-monospace" name="input1" readonly value="{$baseUrl}/link/{$ssr_sub_token}?mu=0" readonly="true"><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$baseUrl}/link/{$ssr_sub_token}?mu=0">點擊拷貝訂閱地址</button><br>
													...
													<div class="tab-pane fade" id="all_ssr_android">
                                                      ...
                                                      <p><span class="icon icon-lg text-white">filter_5</span> 訂閱出現系統自帶的與仟佰星雲，請把系統自帶的無效訂閱左滑刪除（自帶影響訂閱更新速度）</p>
                                                  ...
                                                  <div class="tab-pane fade" id="all_ssr_info">
														...
														<dl class="dl-horizontal">
                                                          <p><dt><code>優點導入普通端口，如果普通端口無法使用再導入單端口</code></dt></p>
															<p><dt>端口</dt>
															<dd>{$user->port}</dd></p>
												...
												<div class="tab-pane fade {if !$ssr_prefer}active in{/if}" id="all_ss">
													...
													<div class="tab-pane fade" id="all_ss_mac">
														<p><a href="/ssr-download/ss-mac.zip">下載</a>，安裝，然後下載<a href="/user/getpcconf?is_mu=0&is_ss=1">這個（普通端口）</a>或者<a href="/user/getpcconf?is_mu=1&is_ss=1">這個（單端口多用戶）</a>，運行程序，小飛機上右鍵 服務器列表 子菜單 的 “導入服務器配置文件...” 導入這個文件，然後選擇一個合適的服務器，更新一下PAC，然後開啓系統代理即可上網。</p>
													</div>
													<div class="tab-pane fade" id="all_ss_ios">
														<p>推薦下載<a href="https://itunes.apple.com/cn/app/shadowrocket/id932747118?mt=8">Shadowrocket</a>，已購買此軟件的美國商店Apple ID:<code>shz7348@icloud.com</code> 密碼<code>Qq654321.</code>注意特殊符號與大小寫,自行切換商店賬號下載安裝，然後在 Safari 中點擊<a href="{$ss_url_all}">這個（普通端口）</a>或者<a href="{$ss_url_all_mu}">這個（單端口多用戶）</a>，然後點擊確定，就可以批量添加節點。</p>
													...
													<div class="tab-pane fade" id="all_ss_android">
														<p><a href="/ssr-download/ss-android.apk">下載</a>，再<a href="/ssr-download/ss-android-obfs.apk">下載</a>，然後安裝，然後在手機上點擊 <a class="copy-text" data-clipboard-text="{$ss_url_all}"> 這個鏈接（普通端口）</a>或者<a class="copy-text" data-clipboard-text="{$ss_url_all_mu}">這個鏈接（單端口多用戶端口）</a>複制到剪貼板，打開 Shadowsocks 客戶端，選擇從剪貼板導入，然後選擇一個節點，設置一下路由爲繞過大陸，點擊飛機就可以上網了。</p>
													</div>
                                         ...
                                         theme: "light1",
												...
												data: [
												{
													...
													dataPoints: [
														...
														{
															y: {$user->last_day_t/$user->transfer_enable*100},label: "總已用", legendText:"總已用 {number_format($user->last_day_t/$user->transfer_enable*100,2)}% {$user->LastusedTraffic()}", indexLabel: "總已用 {number_format($user->last_day_t/$user->transfer_enable*100,2)}% {$user->LastusedTraffic()}"
														},
														{
