                    ...
                    <div class="tab-content">
                      <div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
                        ...
                        <nav class="tab-nav margin-top-no">
                          <ul class="nav nav-list">
                            <li class="active">
                              <a class="waves-attach" data-toggle="tab" href="#all_ssr_windows">
                            ...
                            <li>
                              <a class="waves-attach" data-toggle="tab" href="#all_ssr_android">
                                <i class="fab fa-android fa-lg"></i>&nbsp;Android</a>
                            </li>
                            <li>
                              <a class="waves-attach" data-toggle="tab" href="#all_ssr_router">
                          ...
                          <div class="tab-pane fade active in" id="all_ssr_windows">
                            ...
                            <div class="tab-pane fade" id="all_ssr_mac">
                              ...
                              <p>
                                ...
                                菜單欄的<i class="fas fa-paper-plane fa-flip-horizontal"></i>圖標--服務器--服務器訂閱填入以下訂閱地址--最後更新一下；</p>
                              <p>
                                <span class="icon icon-lg text-white">looks_5</span>
                              ...
                              <div class="tab-pane fade" id="all_ssr_linux">
                                ...
                                <div class="tab-pane fade" id="all_ssr_ios">
                                  <p>
                                    ...
                                    密碼<code>Qq#123456</code>注意區分特殊符號與大小寫,如果提示需要賬號被鎖，請聯繫管理員（請勿在iCloud中登錄本賬號）；</p>
                                  <p>
                                    <span class="icon icon-lg text-white">looks_two</span>
                                  ...
                                  <p>
                                    <span class="icon icon-lg text-white">looks_3</span>
                                    打開軟件，點擊右上角<i class="fas fa-plus"></i>，選擇添加類型為<code>Subscribe</code>，URL填寫以下地址即可自動獲取線路信息</p>
                                  <p>
                                    <span class="icon icon-lg text-white">looks_4</span>
                                  ...
                                  <div class="tab-pane fade" id="all_ssr_android">
                                    ...
                                    <p>
                                      ...
                                      點擊右上角的点击右上角<i class="fas fa-paper-plane fa-flip-horizontal"></i>，即可連接。</p>
                                    ...
                                    <div class="tab-pane fade" id="all_ssr_game">
                                      ...
                                      <p>
                                        <span class="icon icon-lg text-white">looks_5</span>
                                        更新后選擇線路，點擊<i class="fas fa-bolt"></i>測試 - 測試UDP轉發...通過!（UDP通過即可連接并開始遊戲；如測試不通過，點擊如测试不通过<i class="fas fa-cog"></i>--設置--修改DNS，推薦谷歌DNS</p>
                                    ...
                                    <div class="tab-pane fade {if !$ssr_prefer}active in{/if}" id="all_ss">
                                      <nav class="tab-nav margin-top-no">
                                        <ul class="nav nav-list">
                                          ...
                                          <li>
                                            <a class="waves-attach" data-toggle="tab" href="#all_ss_windows">
                                          ...
                                          <li>
                                            <a class="waves-attach" data-toggle="tab" href="#all_ss_android">
                                      ...
                                      <div class="tab-pane fade" id="all_ss_windows">
                                        ...
                                        <div class="tab-pane fade" id="all_ss_mac">
                                          <p>
                                            <a href="/ssr-download/ss-mac.zip">下载</a>，安装，然后下载<a href="/user/getpcconf?is_mu=0&is_ss=1">这个（普通端口）</a>或者<a href="/user/getpcconf?is_mu=1&is_ss=1">这个（单端口多用户）</a>，运行程序，小飞机上右键 服务器列表 子菜单 的 “导入服务器配置文件...” 导入这个文件，然后选择一个合适的服务器，更新一下PAC，然后开启系统代理即可上网。</p>
                                        </div>
                                        <div class="tab-pane fade" id="all_ss_ios">
                                          <p>推荐下载<a href="https://itunes.apple.com/cn/app/shadowrocket/id932747118?mt=8">Shadowrocket</a>，已购买此软件的美国商店Apple ID:<code>shz7348@icloud.com</code>
                                            密码<code>Qq654321.</code>注意特殊符号与大小写,自行切换商店账号下载安装，然后在 Safari 中点击<a href="{$ss_url_all}">这个（普通端口）</a>或者<a href="{$ss_url_all_mu}">这个（单端口多用户）</a>，然后点击确定，就可以批量添加节点。</p>
                                        ...
                                        <div class="tab-pane fade" id="all_ss_android">
                                          <p>
                                            <a href="/ssr-download/ss-android.apk">下载</a>，再<a href="/ssr-download/ss-android-obfs.apk">下载</a>，然后安装，然后在手机上点击
                                            <a class="copy-text" data-clipboard-text="{$ss_url_all}">
                                              这个链接（普通端口）</a>或者<a class="copy-text" data-clipboard-text="{$ss_url_all_mu}">这个链接（单端口多用户端口）</a>复制到剪贴板，打开 Shadowsocks 客户端，选择从剪贴板导入，然后选择一个节点，设置一下路由为绕过大陆，点击飞机就可以上网了。</p>
                                        </div>
                                ...
                                訂閱地址：
                                <input type="text" class="input form-control form-control-monospace" name="input1" readonly="true" value="{$baseUrl}/link/{$ssr_sub_token}?mu=1">
                                ...
                                <div class="card-inner margin-bottom-no">
                                  ...
                                  <dl class="dl-horizontal">
                                    <p>
                                      ...
                                      {if $user->class!=0}
                                      <dd>
                                        <i class="icon icon-md t4-text">stars</i>&nbsp;<code>VIP{$user->class}<code></dd>
                                          {else}
                                          <dd>
                                            <i class="icon icon-md t4-text">stars</i>&nbsp;免費</dd>
                                          {/if}
                                          <p>
                                            <strong>服務到期：</strong>
                                            ...
                                            {else}
                                            <dd>
                                              <i class="icon icon-md">event</i>&nbsp;不过期</dd>
                                            {/if}
                                            <p>
                                              <strong>帐号到期：</strong>
                                              <dd>
                                              ...
                                              <p>
                                                ...
                                                <dd>
                                                  <i class="icon icon-md">settings_input_component</i>&nbsp;{$user->node_speedlimit}兆</dd>
                                                {else}
                                                <dd>
                                                  <i class="icon icon-md">settings_input_component</i>&nbsp;不限速</dd>
                                                {/if}
                                                <p>
                                                  <dt>設備上限</dt>
                                                  <dd>
                                                    <i class="icon icon-md">phonelink</i>&nbsp;{$user->online_ip_count()} / {$user->node_connector}</dd>
                                                  <p>
                                                    <dt>賬號餘額</dt>
                                                    <dd>
                                                      <i class="icon icon-md">monetization_on</i>&nbsp;{$user->money} 元</dd>
                                                    <p>
                                                      <dt>最近使用</dt>
                                                      ...
                                                      {else}
                                                      <dd>
                                                        <i class="icon icon-md">event</i>&nbsp;無記錄</dd>
                                                      {/if}</p>
