				...
				<section class="content-inner">
					<nav class="tab-nav margin-top-no">
						<ul class="nav nav-justified">
							...
							<li>
								<a class="waves-attach" data-toggle="tab" href="#qrcode_login">
									TG掃碼登錄</a>
							</li>
							{/if}
							<li class="active">
								<a class="waves-attach" data-toggle="tab" href="#passwd_login">密碼登錄</a>
							</li>
							{if $config['enable_telegram'] == 'true'}
							<li>
								<a class="waves-attach" data-toggle="tab" href="#number_login">
									TG數字登錄</a>
							</li>
							{/if}
						</ul>
								...
								<div class="card">
									<div class="card-main">
										<div class="card-header">
											<div class="card-inner">
												<h1 class="card-heading">登錄到用戶中心</h1>
											</div>
										</div>
										<div class="card-inner">
												...
												<div class="form-group form-group-label">
													<div class="row">
														<div class="col-md-10 col-md-push-1">
															<label class="floating-label" for="email">郵箱</label>
							...
							<div class="tab-pane fade" id="qrcode_login">
								<div class="card">
									<div class="card-main">
										<div class="card-header">
											<div class="card-inner">
												<h1 class="card-heading">Telegram掃碼登錄</h1>
											</div>
										</div>
										<div class="card-inner">
											<p>添加機器人
												<a href="https://t.me/{$telegram_bot}">@{$telegram_bot}</a>，將下面的二維碼發給她</p>
											<div class="form-group form-group-label">
							...
							<div class="tab-pane fade" id="number_login">
								<div class="card">
									<div class="card-main">
										<div class="card-header">
											<div class="card-inner">
												<h1 class="card-heading">Telegram數字登錄</h1>
											</div>
										</div>
										<div class="card-inner">
											<p>添加機器人
												<a href="https://t.me/{$telegram_bot}">@{$telegram_bot}</a>，將下面的數字發給她</p>
											<div class="form-group form-group-label">
												<div class="text-center">
													<h1>
														<code id="code_number">{$login_number}</code>
													</h1>
												</div>
											</div>
										</div>
					...
					<div class="clearfix">
						<p class="margin-no-top pull-left">
							<a class="btn btn-flat btn-brand waves-attach" href="/password/reset">忘記密碼</a>
						</p>
						<p class="margin-no-top pull-right">
							<a class="btn btn-flat btn-brand waves-attach" href="/auth/register">註冊賬號</a>
						</p>
					</div>
...
<script>
	...
	initGeetest({
		gt: "{$geetest_html->gt}", challenge: "{$geetest_html->challenge}", product: "embed", // 产品形式，包括：float，embed，popup。注意只对PC版验证码有效
		offline: {
