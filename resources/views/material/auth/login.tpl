                ...
                <section class="content-inner">
                    <nav class="tab-nav margin-top-no">
                        <ul class="nav nav-justified">
                            ...
                            {/if}
                            <li class="active"><a class="waves-attach" data-toggle="tab" href="#passwd_login">密碼登錄</a>
                            </li>
                            {if $config['enable_telegram'] == 'true'}
                                        ...
                                        <div class="card-inner">
                                            <form action="javascript:void(0);" method="POST">
                                                <div class="form-group form-group-label">
                                                    <div class="row">
                                                        <div class="col-md-10 col-md-push-1"><label
                                                                    class="floating-label" for="email">郵箱</label>
                                ...
                                <div class="tab-pane fade" id="qrcode_login">
                                    <div class="card">
                                        <div class="card-main">
                                            ...
                                            <div class="card-inner">
                                                <p>添加機器人 <a href="https://t.me/{$telegram_bot}">@{$telegram_bot}</a>，將下面的二維碼發給她
                                                </p>
                                                <div class="form-group form-group-label">
                                ...
                                <div class="tab-pane fade" id="number_login">
                                    <div class="card">
                                        <div class="card-main">
                                            ...
                                            <div class="card-inner">
                                                <p>添加機器人 <a href="https://t.me/{$telegram_bot}">@{$telegram_bot}</a>，將下面的數字發給她
                                                </p>
                                                <div class="form-group form-group-label">
                                                    <div class="text-center">
